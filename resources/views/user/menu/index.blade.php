...
<style>
    ...
    /* Membuat seluruh kartu bisa diklik */
    .menu-item { background: white; border-radius: 8px; overflow: hidden; box-shadow: 0 5px 15px rgba(0, 0, 0, 0.1); transition: all 0.3s ease; display: flex; flex-direction: column; cursor: pointer; }
                ...
                <div class="menu-item">
                    ...
                    <div class="menu-item-content">
                        ...
                        <div class="menu-item-meta">
                            ...
                            {{-- Tombol ini sekarang menjadi pemicu modal --}}
                            <button type="button" 
                                    class="menu-item-btn item-modal-trigger" 
                                    data-id="{{ $item->id }}"
                                    data-name="{{ $item->name }}"
